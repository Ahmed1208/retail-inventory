      ...
      >
        ...
        <div className="relative shrink-0 border-b bg-muted/30 px-4 py-3">
          ...
          <Input
            ...
            placeholder={t('purchaseOrders.searchSuppliers')}
            className="ps-9"
          />
        </div>

        <p className="shrink-0 px-4 py-2 text-xs text-muted-foreground">
          {t('purchaseOrders.pressF1Supplier')}
        </p>
        ...
        <div className="min-h-0 flex-1 overflow-y-auto px-4 pb-6">
          <div className="grid grid-cols-1 gap-2 sm:grid-cols-2">
            ...
            >
              <div className="font-medium">{t('purchaseOrders.noLinkedSupplier')}</div>
              <div className="mt-1 text-xs text-muted-foreground">
                {t('purchaseOrders.noLinkedSupplierHint')}
              </div>
            </button>
