-- Ensures next_standalone_ledger_ref exists and PostgREST picks it up (schema cache).
-- Safe if 011 already ran: sequences IF NOT EXISTS, function CREATE OR REPLACE.
